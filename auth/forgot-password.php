...
<div class="login-form">
    <form method="post" action="reset-password.php" autocomplete="off">
        <fieldset class="fieldset">
            <legend class="text">Forgot Password</legend>
            <p>
                Enter the email address you signed up with for password recovery then check your email inbox after submiting</p>
            ...
            <div class="form-group">
                <button type="submit" class="btn btn-success btn-block login-btn">Send</button>
            </div>
